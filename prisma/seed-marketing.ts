...
async function main() {
  ...
  const customerSpecs: CustomerSpec[] = [
    {
      name: "Willow Bend Farms",
      email: "amy@willowbend.farm",
      phone: "308-555-4001",
      address: "21480 Highway 30, Kearney, NE",
      storeId: kearney.id,
      contact: { name: "Amy Keller", phone: "308-555-4001", email: "amy@willowbend.farm" },
      extraContact: { name: "Ned Keller", phone: "308-555-4002", email: "ned@willowbend.farm" },
      farms: [
    ...
    {
      name: "North Fork Cattle",
      email: "carl@northforkcattle.farm",
      phone: "308-555-4010",
      address: "880 County Road 40, Gibbon, NE",
      storeId: kearney.id,
      contact: { name: "Carl Benson", phone: "308-555-4010", email: "carl@northforkcattle.farm" },
      farms: [
    ...
    {
      name: "Cedar Lot Grain",
      email: "rita@cedarlot.farm",
      phone: "308-555-4020",
      address: "12 Elevator Rd, Elm Creek, NE",
      storeId: kearney.id,
      contact: { name: "Rita Hale", phone: "308-555-4020", email: "rita@cedarlot.farm" },
      farms: [{ name: "Elevator farm", location: "West of town", ...pin(K.lat, K.lng, 0.04, 0.28) }],
    },
    {
      name: "Open Ridge Farms",
      email: "owen@openridge.farm",
      phone: "308-555-4030",
      address: "44100 Road 442, Holdrege, NE",
      storeId: holdrege.id,
      contact: { name: "Owen Pike", phone: "308-555-4030", email: "owen@openridge.farm" },
      extraContact: { name: "Sasha Pike", phone: "308-555-4031", email: "sasha@openridge.farm" },
      farms: [
    ...
    {
      name: "County Line Farms",
      email: "lee@countyline.farm",
      phone: "308-555-4040",
      address: "900 30th Ave, Kearney, NE",
      storeId: kearney.id,
      contact: { name: "Lee Finch", phone: "308-555-4040", email: "lee@countyline.farm" },
      farms: [
    ...
    {
      name: "Sandbar Ranch",
      email: "maya@sandbar.farm",
      phone: "308-555-4050",
      address: "Rural Route 2, Lexington, NE",
      storeId: lexington.id,
      contact: { name: "Maya Walsh", phone: "308-555-4050", email: "maya@sandbar.farm" },
      farms: [
    ...
    },
    {
      ...
      email: "jon@eveningstar.farm",
      phone: "308-555-4060",
      address: "55 Pioneer Ave, Minden, NE",
      storeId: holdrege.id,
      contact: { name: "Jon Ruiz", phone: "308-555-4060", email: "jon@eveningstar.farm" },
      farms: [{ name: "Home farm", location: "South of Minden", ...pin(H.lat, H.lng, 0.16, -0.12) }],
    },
    {
      name: "Canal Side Produce",
      email: "ana@canalside.farm",
      phone: "308-555-4070",
      address: "2200 Avenue N, Kearney, NE",
      storeId: kearney.id,
      contact: { name: "Ana Chen", phone: "308-555-4070", email: "ana@canalside.farm" },
      farms: [
    ...
    {
      name: "West Draw Land",
      email: "hugh@westdraw.farm",
      phone: "308-555-4080",
      address: "14 Main St, Lexington, NE",
      storeId: lexington.id,
      contact: { name: "Hugh Ortiz", phone: "308-555-4080", email: "hugh@westdraw.farm" },
      farms: [
    ...
    {
      name: "Little Fork Farms",
      email: "tess@littlefork.farm",
      phone: "308-555-4090",
      address: "County Road 18, Pleasanton, NE",
      storeId: kearney.id,
      contact: { name: "Tess Hale", phone: "308-555-4090", email: "tess@littlefork.farm" },
      extraContact: { name: "Cal Hale", phone: "308-555-4091", email: "cal@littlefork.farm" },
      farms: [
  ...
  const farmerLogins = [
    { farmer: farmers[0], email: "amy@willowbend.farm", name: "Amy Keller" },
    { farmer: farmers[3], email: "owen@openridge.farm", name: "Owen Pike" },
    { farmer: farmers[5], email: "maya@sandbar.farm", name: "Maya Walsh" },
    { farmer: farmers[9], email: "tess@littlefork.farm", name: "Tess Hale" },
  ];
  ...
  const jobs: {
    ...
    },
    {
      ...
      description: "Standby gen at Sandbar Ranch. Fuel and batteries checked by farmer.",
      status: "ASSIGNED",
      priority: "URGENT",
    ...
    },
    {
      ...
      status: "CANCELLED",
      priority: "NORMAL",
      updates: [{ userId: alex.id, message: "Cancelled per Amy. Reopen after harvest if needed.", status: "CANCELLED" }],
    },
    {
      pivot: pivots[10],
      tech: megan,
    ...
    },
    {
      ...
      updates: [{ userId: carlos.id, message: "Ready for farmer. Texted Amy.", status: "REPAIR_DONE" }],
  ...
  const demoGps = [
    {
      ...
      address: "Willow Bend north pivot, Highway 30, Kearney, NE",
    ...
    },
    {
      ...
      address: "Open Ridge north section, Holdrege, NE",
      displayState: "Stopped",
      techId: ty.id,
    },
    {
      ...
      address: "Sandbar north grass, Lexington, NE",
      displayState: "Stopped",
      techId: jordan.id,
    },
    {
  ...
  console.log("Also: manager@highplains.ag, carlos@highplains.ag, amy@willowbend.farm");
}
