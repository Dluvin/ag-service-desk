  ...
  return (
    <section className="mt-8">
      ...
      <p className="mt-2 text-sm text-stone-600">
        ...
        customer. Assets labeled Unassigned stay with this customer.
      </p>
      {farms.length ? (
      ...
      {canEdit ? (
        <ActionForm action={createFarmAction} className="mt-3 space-y-3 rounded-xl border border-stone-200 bg-white p-4">
