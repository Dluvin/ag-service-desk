  ...
  return (
    <div>
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-stone-600">
            Ticket and pivot activity from {report.range.from} through {report.range.to}.
          </p>
        </div>
      ...
      <section id="ticket-reports" className="mt-10 scroll-mt-6">
        <h2 className="font-display text-2xl">Ticket reports</h2>
        ...
        <TableCard title="Closed tickets in range" className="mt-6">
          <table className="w-full text-left text-sm">
            <thead className="bg-stone-50 text-xs uppercase tracking-wide text-stone-500">
              <tr>
                <th className="px-3 py-2">Ticket</th>
                <th className="px-3 py-2">Farm / pivot</th>
      ...
      <section id="pivot-reports" className="mt-12 scroll-mt-6">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Stat label="With open tickets" value={String(report.pivot.withOpenWork)} />
          <Stat label="No tickets in range" value={String(report.pivot.quietInRange)} />
          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-stone-50 text-xs uppercase tracking-wide text-stone-500">
              <tr>
                ...
                <th className="px-3 py-2">Last ticket</th>
        ...
        <TableCard title="Pivots with open tickets" className="mt-6">
          <table className="w-full text-left text-sm">
            <thead className="bg-stone-50 text-xs uppercase tracking-wide text-stone-500">
              <tr>
                <th className="px-3 py-2">Pivot</th>
            ...
            <tbody className="divide-y divide-stone-100">
              {report.pivot.openWork.length === 0 ? (
                <tr>
                  <td colSpan={4} className="px-3 py-4 text-stone-600">
                    No open tickets on pivots in this view.
                  </td>
                </tr>
              ) : (
